...
n("#view-more-projects").click(function(e){
    e.preventDefault(),
    n(this).fadeOut(100,function(){
        n("#more-projects").fadeIn(25)
    })
})
}(jQuery);
